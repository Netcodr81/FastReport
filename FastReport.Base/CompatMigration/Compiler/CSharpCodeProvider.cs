...
namespace FastReport.Code.CSharp
{
    public class CSharpCodeProvider : CodeDomProvider
    {
        ...
        protected override Microsoft.CodeAnalysis.Compilation CreateCompilation(SyntaxTree codeTree, ICollection<MetadataReference> references)
        {
            CSharpCompilationOptions options = GetCompilationOptions();
            Microsoft.CodeAnalysis.Compilation compilation = CSharpCompilation.Create(
