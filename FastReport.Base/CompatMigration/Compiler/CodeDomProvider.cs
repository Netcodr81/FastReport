...
namespace FastReport.Code.CodeDom.Compiler
{
    public abstract class CodeDomProvider : IDisposable
    {
        ...
        private void OnBeforeEmitCompilation(Microsoft.CodeAnalysis.Compilation compilation)
        {
...
#pragma warning restore CS0618
        ...
        public CompilerResults CompileAssemblyFromSource(CompilerParameters cp, string code, CultureInfo cultureInfo = null)
        {
            ...
            Microsoft.CodeAnalysis.Compilation compilation = CreateCompilation(codeTree, references);
        ...
        protected abstract Microsoft.CodeAnalysis.Compilation CreateCompilation(SyntaxTree codeTree, ICollection<MetadataReference> references);
        ...
        private static CompilerResults Emit(Microsoft.CodeAnalysis.Compilation compilation, CultureInfo cultureInfo, CancellationToken ct = default)
        {
        ...
        private static async Task<CompilerResults> EmitAsync(Microsoft.CodeAnalysis.Compilation compilation, CultureInfo cultureInfo, CancellationToken ct = default)
        {
            using (MemoryStream ms = new MemoryStream())
            {
                DebugMessage("Emit...");
