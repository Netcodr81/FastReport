    ...
    internal class PaddingConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            if (value is string)
            {
                ...
                {
                    val[i] = (int)FormsConverter.FromString(typeof(int), values[i]);
                }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                builder.Append(FormsConverter.ToString(p.Left)).Append(",");
                builder.Append(FormsConverter.ToString(p.Top)).Append(",");
                builder.Append(FormsConverter.ToString(p.Right)).Append(",");
                builder.Append(FormsConverter.ToString(p.Bottom));
