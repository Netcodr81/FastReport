...
namespace FastReport
{
    ...
    public interface IGraphics : IDisposable
    {
        ...
        SizeF MeasureText(string text, TextPaint paint);
        SizeF MeasureText(string text, TextPaint paint, float maxWidth);
        ...
        void DrawImage(ImagePaint paint, RectangleF destRect);
        void DrawImage(ImagePaint paint, RectangleF destRect, RectangleF srcRect);
    ...
    public sealed class TextPaint
    {
        ...
        public StringFormat Format { get; set; } = StringFormat.GenericDefault;

        public TextPaint()
        {
        }

        public TextPaint(Font font, Brush brush, StringFormat format = null)
        {
            Font = font;
            Brush = brush;
    ...
    public sealed class ImagePaint
    {
        ...
        public ImagePaint(Image image, RectangleF sourceRect)
        {
            Image = image;
