...
public partial class ReportPage : PageBase, IParent
{
    ...
    private void DrawBackground(FRPaintEventArgs e, SKRect rect)
    {
        Fill.Draw(e, rect);
    }
    #endregion
    ...
    public override void Draw(FRPaintEventArgs e)
    {
        ...
        SKRect pageRect = new SKRect(0, 0,
          WidthInPixels - 1 / e.ScaleX, HeightInPixels - 1 / e.ScaleY);
        SKRect printableRect = new SKRect(
          LeftMargin * Units.Millimeters,
          TopMargin * Units.Millimeters,
          LeftMargin * Units.Millimeters + (PaperWidth - LeftMargin - RightMargin) * Units.Millimeters,
          TopMargin * Units.Millimeters + (PaperHeight - TopMargin - BottomMargin) * Units.Millimeters);
        ...
        {
            printableRect = new SKRect(
                pageRect.Left + LeftMargin * Units.Millimeters,
                pageRect.Top + TopMargin * Units.Millimeters,
                pageRect.Right - RightMargin * Units.Millimeters,
                pageRect.Bottom - BottomMargin * Units.Millimeters);
        }
        IGraphicsState state = g.Save();
        e.Graphics.SetClip(new SKRect(pageRect.Left * e.ScaleX, pageRect.Top * e.ScaleY, pageRect.Right * e.ScaleX, pageRect.Bottom * e.ScaleY));
    ...
    public ReportPage()
    {
        ...
        border = new Border();
        fill = new SolidFill(SKColors.White);
