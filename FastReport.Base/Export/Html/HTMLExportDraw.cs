...
public partial class HTMLExport : ExportBase
{
    ...
    private void HTMLPadding(FastString PaddingDesc, SKRect padding, float ParagraphOffset)
    {
    ...
    private void HTMLGetStyle(FastString style, SKFont Font, SKColor TextColor, SKColor FillColor, HorzAlign HAlign, VertAlign VAlign,
        Border Border, SKRect Padding, bool RTL, bool wordWrap, float LineHeight, float ParagraphOffset)
    {
